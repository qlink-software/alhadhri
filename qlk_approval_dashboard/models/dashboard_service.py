...
class QlkApprovalDashboard(models.AbstractModel):
    ...
    DASHBOARD_ACCESS_GROUPS = (
        "qlk_approval_dashboard.group_approval_dashboard_manager",
        "qlk_approval_dashboard.group_approval_dashboard_assistant",
        ...
        "qlk_management.group_qlk_lawyers",
        "qlk_management.group_qlk_managers",
