...
class QlkBusinessDevelopmentDashboard(models.AbstractModel):
    ...
    def get_dashboard_data(self):
        ...
        pipeline_states = ("draft", "waiting_manager_approval", "waiting_client_approval", "approved_client")
            ...
            proposal_records.append(
                {
                    "id": proposal.id,
                    "title": proposal.name,
                    "client": proposal.partner_id.display_name or "",
        ...
        followup_domain = [("state", "in", ("waiting_manager_approval", "waiting_client_approval"))]
        followup_items = []
